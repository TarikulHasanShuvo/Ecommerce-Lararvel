					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							@foreach($data as $category)
									...
									@php
										$sub_categories=App\SubCategory::all()->where('category_id',$category->id);
									@endphp
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordian" href="#sportswear{{$category->id}}">
												...
												<a href="{{route('category.product',['id'=>$category->id])}}">{{$category->name}}</a>
											...
											<div class="panel-body">
												<ul>
													@foreach($sub_categories as $sub_category)
														<li><a href="{{route('sub_category.product',['id'=>$sub_category->id])}}">{{$sub_category->s_name}} </a></li>
													@endforeach
												</ul>
											</div>
										</div>
