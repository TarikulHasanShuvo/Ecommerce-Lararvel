...
@section('content')
					...
					<h2 class="title text-center">Sub Category Product</h2>
					@foreach ($products  as $product)
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="{{asset('images').'/'.$product->image}}"  style="height: 250px" alt="" />
										<h2>${{$product->price}}</h2>
											<p>{{$product->p_name}}</p>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<p>{{$product->p_name}}</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												<a href="{{route('single.product',['id'=>$product->id])}}"class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View Details</a>
											</div>
										</div>
								</div>
								<div class="choose">
